...
while True:
    ...
    salario = float(input(' Digite o Salário dos funcionários  e 0 para encerrar ): '))
...
for salario in listasalarios:
    ...
    print (' Salario : ', salario ,'---',' Abono :', abono)
    

print ( 'Total de funcionario : ', len(listasalarios))
print (' Total gasto com abonos : ', total_abono)
print ( ' Valor minimo pago : ', quant_minimo)
print (' Maior valor pago por abono : ', maior_abono)
